...
var dataproviderlist=angular.module('dataproviderlist',[]);
dataproviderlist.controller('dataProviderlist',function($scope){
	...
	$scope.addrequester=function()
	{
		...
		$scope.myContractInstance.addNewRequester.sendTransaction($scope.dataname,$scope.requesteraddress,{from:$scope.from,gas:40000000});
	};
});